...
export default function Head() {
  ...
  return (
    <div className="flex h-full w-full flex-col gap-3 sm:gap-5 sm:p-0 ">
      ...
      <div className="text-5xl  font-bold text-white">{t("title")}</div>

      <div className="w-full sm:w-9/12 text-sm sm:text-xl text-gray ">
        {t("description")}
      </div>
    </div>
  );
