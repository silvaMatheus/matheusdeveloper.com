...
export const DirectionAwareHover = ({
    ...
    return (
        <motion.div
            ...
            ref={ref}
            className={cn(
                'group/card relative h-full w-full overflow-hidden rounded-lg bg-transparent md:h-full md:w-full',
                className
            )}
        >
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <motion.div
                        variants={variants}
                        className="bg-gray-50 relative h-full w-full dark:bg-black"
                        transition={{
                            duration: 0.2,
                            ease: 'easeOut',
                        }}
