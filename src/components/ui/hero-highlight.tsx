...
export const HeroHighlight = ({
    ...
    return (
        <div
            className={cn('group relative flex h-full w-full ', containerClassName)}
        ...
        >
          ...
          `,
            ...
            />
            {showGradient && (
                <div className="pointer-events-none absolute inset-0 h-full  w-full   [mask-image:radial-gradient(ellipse_at_center,transparent,white)]" />
            )}
