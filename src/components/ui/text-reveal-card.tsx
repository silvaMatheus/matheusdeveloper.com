            ...
            <div className="relative flex h-40 items-center overflow-hidden">
                ...
                >
                    <p
                        ...
                        className="bg-gradient-to-b from-white to-neutral-300 bg-clip-text py-10  text-center text-sm font-bold text-transparent text-white"
                    >
                        {revealText}
                    </p>
                </motion.div>
                ...
                <div className="w-full overflow-hidden text-center [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
                    <p className="bg-[#323238] bg-clip-text py-10 text-2xl font-bold text-transparent ">
                        {text}
                    </p>
                    <MemoizedStars />
                </div>
